...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        # nav2_params_rtab.yaml is the ONLY params file shipped in this app (the sim's nav2_params.yaml was
        # dropped in the port). real_bringup always passes it explicitly; this default just makes a manual
        # standalone `ros2 launch go2_bringup nav2.launch.py` work instead of failing on a missing file.
